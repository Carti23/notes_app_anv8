...
class User(AbstractUser):
    ...
    contacts = models.ManyToManyField(
        "self", through="UserContact", symmetrical=False, related_name="user_contacts"
    )
    ...
    def get_contacts(self):
        ...
        return User.objects.filter(contact_relationships__user=self)
...
class UserContact(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="user_relationships"
    )
    contact = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="contact_relationships"
    )
