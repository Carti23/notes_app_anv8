...
from .permissions import IsContactOwner, IsOwner
...
from .services import blacklist_token, get_tokens_for_user
from .throttling import AuthRateThrottle, ContactRateThrottle, UserSearchRateThrottle
...
class UserViewSet(
    ...
    def find(self, request: Request, *args: Any, **kwargs: Any) -> Response:
        ...
        serializer = UserSearchSerializer(
            data=request.query_params, only_fields=["email"]
        )
        serializer.is_valid(raise_exception=True)
    ...
    def create(self, request: Request, *args: Any, **kwargs: Any) -> Response:
        ...
        try:
            ...
            contact, created = UserContact.objects.get_or_create(
                user=request.user, contact=contact_user, defaults={"nickname": nickname}
            )
