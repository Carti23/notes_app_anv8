...
class TestNoteEndpoints:
    ...
    def test_list_notes(self, authenticated_client, test_user):
        ...
        Note.objects.create(owner=test_user, title="Note 1", content="Content 1")
        Note.objects.create(owner=test_user, title="Note 2", content="Content 2")
    ...
    def test_get_note_detail(self, authenticated_client, test_user):
        ...
        note = Note.objects.create(
            owner=test_user, title="Test Note", content="Test Content"
        )
    ...
    def test_update_note(self, authenticated_client, test_user):
        ...
        """
        note = Note.objects.create(
            owner=test_user, title="Original Title", content="Original Content"
        )
    ...
    def test_access_other_user_note(self, authenticated_client, test_user2):
        ...
        """
        note = Note.objects.create(
            owner=test_user2, title="Other User Note", content="Other User Content"
        )
