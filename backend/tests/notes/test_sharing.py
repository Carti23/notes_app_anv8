...
class TestNoteSharing:
    ...
    def test_share_note(self, authenticated_client, test_user, test_user2):
        ...
        note = Note.objects.create(
            owner=test_user, title="Shared Note", content="Shared Content"
        )
    ...
    def test_list_shared_notes(self, api_client, test_user, test_user2):
        ...
        Note.objects.create(owner=test_user, title="Shared Note 1", content="Content 1")
        note2 = Note.objects.create(
            owner=test_user, title="Shared Note 2", content="Content 2"
        )
